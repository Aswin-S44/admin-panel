  ...
  return (
    <div className="container">
        ...
        <tbody>
          {filteredEnquiries.map((enquiry) => (
            <tr key={enquiry._id}>
              ...
              <td>{enquiry.allow_whatsapp_notification ? "Yes" : "No"}</td>
                ...
                {enquiry?.carPurchased == false ? (
                  <>
                    <select
                      ...
                      onChange={(e) =>
                        handleDetailsSentChange(enquiry._id, e.target.value)
                      }
                    >
                      <option value="true">Details Sent</option>
                      <option value="false">Details Not Sent</option>
      ...
      <div className="pagination">
        ...
        <button
          onClick={() => handlePageChange(filters.page + 1)}
          disabled={filters.page >= Math.ceil(enquiries.total / filters.limit)}
        >
          Next
        </button>
      </div>
